    ...
    return (
        <IonPage id="main-content">
            ...
            <IonContent fullscreen>
                ...
                <IonRow>
                    <IonCol size="12" size-md="8" offset-md="2">
                        <IonSegment className='chart-segment' color="medium" value={type} onIonChange={(e: CustomEvent) => setType(e.detail.value)}>
                            <IonSegmentButton className='chart-segment-button' value="gasto">
                                <IonLabel><b>Gasto</b></IonLabel>
                            </IonSegmentButton>
                            <IonSegmentButton className='chart-segment-button' value="ingreso">
                ...
                <IonGrid>
                    ...
                    <IonRow>
                        <IonCol size="12" size-md="8" offset-md="2">
                            <IonSegment className='chart-segment' color="medium" value={timeRange} onIonChange={(e: CustomEvent) => setTimeRange(e.detail.value)}>
                                <IonSegmentButton className='chart-segment-button' value="today">
                                    <IonLabel><b>Hoy</b></IonLabel>
                                </IonSegmentButton>
                                <IonSegmentButton className='chart-segment-button' value="week">
                                    <IonLabel><b>Semana</b></IonLabel>
                                </IonSegmentButton>
                                <IonSegmentButton className='chart-segment-button' value="month">
                                    <IonLabel><b>Mes</b></IonLabel>
                                </IonSegmentButton>
                                <IonSegmentButton className='chart-segment-button' value="year">
                                    <IonLabel><b>Año</b></IonLabel>
                                </IonSegmentButton>
                                <IonSegmentButton className='chart-segment-button' value="custom" onClick={() => setIsDateModalOpen(true)}>
